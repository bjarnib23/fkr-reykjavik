...
class GiftCardInlineForm extends FormBase {
  ...
  public function getFormId(): string {
    return 'fkr_giftcard_inline_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    try {
      ...
      $form_state->setRedirectUrl(Url::fromRoute('fkr_giftcard.pay', [], [
        'query' => ['checkout_id' => $result['checkout_id']],
      ]));
    }
